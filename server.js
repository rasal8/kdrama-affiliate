...
app.get("/generate", async (req, res) => {
  ...
  <body>
    ...
    <div class="card">
      ...
      <h3>🛍 Shop Inspired</h3>
      <a href="/outfit?name=${encodeURIComponent(d.Title)}" target="_blank">🔥 Korean Outfit</a>
<a href="/accessories?name=${encodeURIComponent(d.Title)}" target="_blank">✨ Accessories</a>
    </div>
